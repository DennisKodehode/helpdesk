...
test.describe.serial("Ticket detail — view", () => {
  let ticketId: number;
...
test.describe.serial("Ticket detail — reply", () => {
  let ticketId: number;
  ...
  test("agent types a reply and it appears in the reply thread after submit", async ({
    ...
    await replyBody.fill("Thank you for reaching out! We will look into this right away.");
...
test.describe.serial("Ticket detail — change status", () => {
  let ticketId: number;
...
test.describe.serial("Ticket detail — change category", () => {
  let ticketId: number;
...
test.describe.serial("Ticket detail — assign ticket", () => {
  let ticketId: number;
